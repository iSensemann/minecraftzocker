		...
		<div id="wrapper" class="background active">
			<div id="sidebar-wrapper" class="animated fadeinleft">
				...
				<ul class="sidebar-nav" id="sidebar">   
					...
					<li class="activep"><a href="../../p/dashboard">Dashboard<span class="c_green sub_icon fa fa-tachometer"></span></a></li>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="dashboard-content">
								<p>Registerd Players:&nbsp;<b><?php include('../../php/registeredplayers.php');?></b></p>
								<a class="members" href="../../p/members">Team members</a>
							</div>
						</div>
					</div>
				</div>
