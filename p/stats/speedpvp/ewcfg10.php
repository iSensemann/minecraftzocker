...
define("EW_PROJECT_NAME", "pvpwebstats2", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{AA815AAB-3B1C-42A2-995A-8F483332E9FF}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'zuM2gcqh5i84DwL6', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/pvpwebstats2.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", 'mysql1.minecraftzocker.net', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'root', TRUE);
define("EW_CONN_PASS", 'EkMrbLXkTWDlIjb5', TRUE);
define("EW_CONN_DB", 'speedpvpstats', TRUE);
