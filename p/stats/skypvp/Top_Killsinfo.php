...
//
// Table class for Top Kills
//
class cTop_Kills extends cTable {
	var $id;
	var $division;
	var $Points;
	var $skins;
	...
	function __construct() {
		...
		$this->TableVar = 'Top_Kills';
		$this->TableName = 'Top Kills';
		...
		// id
		$this->id = new cField('Top_Kills', 'Top Kills', 'x_id', 'id', 'pvpstats.id', 'pvpstats.id', 3, -1, FALSE, 'pvpstats.id', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// division
		$this->division = new cField('Top_Kills', 'Top Kills', 'x_division', 'division', 'pvpstats.kills - pvpstats.kills', 'pvpstats.kills - pvpstats.kills', 20, -1, FALSE, 'pvpstats.kills - pvpstats.kills', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->division->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['division'] = &$this->division;

		// Points
		$this->Points = new cField('Top_Kills', 'Top Kills', 'x_Points', 'Points', 'pvpstats.kills - pvpstats.deaths', 'pvpstats.kills - pvpstats.deaths', 20, -1, FALSE, 'pvpstats.kills - pvpstats.deaths', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Points->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Points'] = &$this->Points;

		// skins
		$this->skins = new cField('Top_Kills', 'Top Kills', 'x_skins', 'skins', 'pvpstats.name', 'pvpstats.name', 200, -1, FALSE, 'pvpstats.name', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['skins'] = &$this->skins;

		// name
		$this->name = new cField('Top_Kills', 'Top Kills', 'x_name', 'name', 'pvpstats.name', 'pvpstats.name', 200, -1, FALSE, 'pvpstats.name', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// kills
		$this->kills = new cField('Top_Kills', 'Top Kills', 'x_kills', 'kills', 'pvpstats.kills', 'pvpstats.kills', 3, -1, FALSE, 'pvpstats.kills', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->kills->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kills'] = &$this->kills;

		// deaths
		$this->deaths = new cField('Top_Kills', 'Top Kills', 'x_deaths', 'deaths', 'pvpstats.deaths', 'pvpstats.deaths', 3, -1, FALSE, 'pvpstats.deaths', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->deaths->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['deaths'] = &$this->deaths;

		// streak
		$this->streak = new cField('Top_Kills', 'Top Kills', 'x_streak', 'streak', 'pvpstats.streak', 'pvpstats.streak', 3, -1, FALSE, 'pvpstats.streak', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("Top_Killsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("Top_Killsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "Top_Killsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("Top_Killsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("Top_Killsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("Top_Killsdelete.php", $this->UrlParm());
	}
