...
class cTop extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('Top', 'Top', 'x_id', 'id', 'mzpvpstats.id', 'mzpvpstats.id', 3, -1, FALSE, 'mzpvpstats.id', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// division
		$this->division = new cField('Top', 'Top', 'x_division', 'division', 'mzpvpstats.kills - mzpvpstats.kills', 'mzpvpstats.kills - mzpvpstats.kills', 20, -1, FALSE, 'mzpvpstats.kills - mzpvpstats.kills', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->division->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['division'] = &$this->division;

		// Points
		$this->Points = new cField('Top', 'Top', 'x_Points', 'Points', 'mzpvpstats.kills - mzpvpstats.deaths', 'mzpvpstats.kills - mzpvpstats.deaths', 20, -1, FALSE, 'mzpvpstats.kills - mzpvpstats.deaths', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Points->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Points'] = &$this->Points;

		// skins
		$this->skins = new cField('Top', 'Top', 'x_skins', 'skins', 'mzpvpstats.name', 'mzpvpstats.name', 200, -1, FALSE, 'mzpvpstats.name', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->skins->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['skins'] = &$this->skins;

		// name
		$this->name = new cField('Top', 'Top', 'x_name', 'name', 'mzpvpstats.name', 'mzpvpstats.name', 200, -1, FALSE, 'mzpvpstats.name', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] = &$this->name;

		// kills
		$this->kills = new cField('Top', 'Top', 'x_kills', 'kills', 'mzpvpstats.kills', 'mzpvpstats.kills', 3, -1, FALSE, 'mzpvpstats.kills', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->kills->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kills'] = &$this->kills;

		// deaths
		$this->deaths = new cField('Top', 'Top', 'x_deaths', 'deaths', 'mzpvpstats.deaths', 'mzpvpstats.deaths', 3, -1, FALSE, 'mzpvpstats.deaths', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlSelect() { // Select
		return "SELECT mzpvpstats.name, mzpvpstats.kills, mzpvpstats.deaths, mzpvpstats.name AS skins, mzpvpstats.kills - mzpvpstats.kills AS division, mzpvpstats.kills - mzpvpstats.deaths AS Points, mzpvpstats.id FROM " . $this->SqlFrom();
	}
	...
	function SqlGroupBy() { // Group By
		return "mzpvpstats.name, mzpvpstats.kills, mzpvpstats.deaths, mzpvpstats.kills - mzpvpstats.kills, mzpvpstats.kills - mzpvpstats.deaths";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("Topview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("Topview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("Topedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("Topadd.php", $this->UrlParm($parm));
	}
   ...
   // Common render codes
	...
	//$YourSQL = "SELECT MAX(points) FROM (SELECT COUNT(*) AS points FROM mzpvpstats WHERE points > 0 GROUP BY player) as counts";
